...
| measurementInterval | Int  | Measurement interval in minutes<br/>Optional, default `0`<br/>Optional: 30/60/120min, default is 60min when enabled<br/>IDR01 project supports App-configured measurement interval |
